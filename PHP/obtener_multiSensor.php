...
/* Hacemos referencia al documento con la conexion */
 ...
 if(isset($_GET["id"]))
 {
    ...
    $sql = "SELECT nombre_lugar, dispositivo, serie_dispositivo FROM dispositivos WHERE id_cliente= '{$Id_Usuario}' AND dispositivo ='Multisensor'";
    ...
    /* Mientras este obteniendo registros */
     ...
     echo json_encode(array("Multisensores" => $datos));
}
else
{
